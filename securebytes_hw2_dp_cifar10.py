...
This script:
1. Trains a baseline CNN on CIFAR10
...
References:
- TensorFlow Privacy CIFAR tutorial
...
def load_cifar10():
    ...
    # CIFAR10 is already [N, 32, 32, 3] with 3 color channels
    # Squeeze label dimension from [N, 1] to [N]
...
def create_model() -> tf.keras.Model:
    ...
    Input: CIFAR10 images with shape (32, 32, 3) for RGB colors
    """
